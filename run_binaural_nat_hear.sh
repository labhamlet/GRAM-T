...
#SBATCH --output=nathear_gram_step/slurm_output_%A_%a.out
#SBATCH --array=0-3
...
tasks_dirs=(
/projects/0/prjs1261/tasks_noisy
/projects/0/prjs1261/tasks_noisy
/projects/0/prjs1338/tasks_noisy
/projects/0/prjs1338/tasks_noisy
/projects/0/prjs1338/tasks_noisy
/projects/0/prjs1338/tasks_noisy
/projects/0/prjs1338/tasks_noisy
...
nr_sample=${nr_samples[$sample_idx]}
task_name=${task_names[$task_idx]}
tasks_dir=${tasks_dirs[$task_idx]}



embeddings_dir=/projects/0/prjs1338/NoisyEmbeddingsGRAMT$nr_sample
score_dir=nathear_gram_$nr_sample
...
#Binaural
weights=/gpfs/work4/0/prjs1338/saved_models_naturalistic_mixing/InChannels=2/Fraction=1.0/CleanDataFraction=0.0/Model=GRAM-T/ModelSize=base/LR=0.0002/BatchSize=96/NrSamples=$nr_sample/Patching=frame/MaskPatch=160/InputL=200/Cluster=False/step=500000.ckpt
in_channels=2
